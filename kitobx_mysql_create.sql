...
insert into kitbox.supplier(name, address) values
('TRABELBO SA ', 'Les Artisans du Bois Parc industriel 9 6124 MARBEHAN'),
('TraitBois SPRL', 'Ebenistes reunis Chemin des 2 Maisons, 140 5150 : Floriffoux');
...
ALTER TABLE `client_order` ADD CONSTRAINT `client_order_fk0` FOREIGN KEY (`id_client`) REFERENCES `client`(`id_client`) ON DELETE CASCADE;

ALTER TABLE `client_order_component` ADD CONSTRAINT `client_order_component_fk0` FOREIGN KEY (`id_order`) REFERENCES `client_order`(`id_order`)ON DELETE CASCADE;

ALTER TABLE `client_order_component` ADD CONSTRAINT `client_order_component_fk1` FOREIGN KEY (`code`) REFERENCES `component`(`code`)ON DELETE CASCADE;

ALTER TABLE `supplier_order_component` ADD CONSTRAINT `supplier_order_component_fk0` FOREIGN KEY (`id_order`) REFERENCES `supplier_order`(`id_order`) ON DELETE CASCADE;

ALTER TABLE `supplier_order_component` ADD CONSTRAINT `supplier_order_component_fk1` FOREIGN KEY (`component_code`) REFERENCES `component`(`code`) ON DELETE CASCADE;

ALTER TABLE `supplier_order` ADD CONSTRAINT `supplier_order_fk0` FOREIGN KEY (`id_supplier`) REFERENCES `supplier`(`id_supplier`) ON DELETE CASCADE;

ALTER TABLE `price` ADD CONSTRAINT `price_fk0` FOREIGN KEY (`id_supplier`) REFERENCES `supplier`(`id_supplier`) ON DELETE CASCADE;

ALTER TABLE `price` ADD CONSTRAINT `price_fk1` FOREIGN KEY (`component_code`) REFERENCES `component`(`code`)ON DELETE CASCADE;
